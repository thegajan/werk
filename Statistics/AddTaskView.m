...
-(void)loadBasicUI {
    ...
    [horizConstraints addObjectsFromArray:[NSLayoutConstraint constraintsWithVisualFormat:@"V:|-12-[_titleInput(66)]-12-[_timeSelection(33)][_timePicker][_confirmTask(54)]-12-|" options:0 metrics:nil views:NSDictionaryOfVariableBindings(_titleInput, _timePicker, _timeSelection, _confirmTask)]];
    [horizConstraints addObjectsFromArray:[NSLayoutConstraint constraintsWithVisualFormat:@"V:|-12-[_descriptionInput]-12-[_confirmTask(54)]-12-|" options:0 metrics:nil views:NSDictionaryOfVariableBindings(_descriptionInput, _confirmTask)]];
