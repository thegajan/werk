...
<header>
    <div id="whole-logo">
        ...
        <div id="logo">
            <ul>
                <li onclick="document.location='main.php'"><div data-icon="ei-pencil"></div></li>
                </li>
    ...
    <nav>
        <div class="ico-shit other add"><div data-icon="ei-plus"></div></div>
        <div class="ico-shit other"><div data-icon="ei-bell"></div></div>
        <div class="ico-shit stuff"><div data-icon="ei-user"></div></div>
<!--    <ul>-->
